...
class Logo extends Component {
  render() {
    var Logo = [];
    var LogoStyle = this.props.LogoStyle;
    ...
    if (LogoStyle === "logomark-color") {
      Logo = () => <svg width="32" height="43" viewBox="0 0 32 43" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
          <defs>
    ...
    if (LogoStyle === "primary-color-white") {
      Logo = () => (
        <svg
          id="Layer_1"
          data-name="Layer 1"
    ...
    return (
      <div className={"logo--shifter logo-" + LogoStyle + " " + className}>
        <Logo />
      </div>
    );
  }
