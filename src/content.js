export const content = {
  ...
  features: {
    hero: {
      title: "Features",
      subtitle:
        "Create secure sites that scale and end downtime with Shifter, the serverless hosting solution and static site generator for WordPress."
    },
    overview: {
      ...
      items: [
        ...
        },
        {
          ...
          subtitle:
            "Static pages load at lightning speed and our global CDN will ensure your site doesn’t fail or slow down from increased traffic anywhere in the world."
        },
        {
          icon: "hammer",
